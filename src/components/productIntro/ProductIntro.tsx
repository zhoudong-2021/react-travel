import { Carousel, Image, Rate, Typography, Table } from 'antd';
        ...
        <div className={styles['intro-container']}>
            ...
            <div className={styles['intro-detail-content']}>
                ...
                <Typography.Text style={{ marginLeft: 50 }}>
                    score: <span className={styles['intro-detail-strong-text']}>{rating}</span>
                </Typography.Text>
            </div>
            <Carousel autoplay slidesToShow={3}>
                {pictures.map(p => (
                    <Image key={generateKey()} height={150} src={p} />
                ))}
            </Carousel>
            <Table<RowType>
                columns={columns}
